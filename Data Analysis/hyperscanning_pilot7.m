...
for stimidx = 1:2
    ...
    for sub = 1:nSubs
        ...
        stimFilename = fullfile(eegFilenames(sub).folder, ['LallNorm_datastim2Sub', int2str(sub), '.mat']);
...
% Save figure
saveas(gcf, 'C:\Users\holly\OneDrive\Documents\Dissertation\Figs\Evaluation\Pilot7.png');
%sgtitle('TRF, GFP, and Topography for Env and Env′');
